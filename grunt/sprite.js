...
module.exports = {
	...
	ui: {
		...
		src: ['dev/image/ui/*.png', '!dev/image/ui/*.not.for.sprite.png'],

		destImg: 'app/resource/img/saike.web.starter.kit-bumblebee/spritesheet.ui.png',

		destCSS: 'app/resource/css/saike.web.starter.kit-bumblebee/spritesheet.ui.css',

		imgPath: '../../img/saike.web.starter.kit-bumblebee/spritesheet.ui.png',
